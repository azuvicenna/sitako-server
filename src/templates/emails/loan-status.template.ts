...
export const renderLoanStatusEmail = (
  data: LoanStatusEmailData,
): {
  subject: string;
  html: string;
} => {
  ...
  switch (status) {
    case 'Menunggu Diambil':
      ...
      description =
        'Pengajuan peminjaman buku Anda telah disetujui oleh pustakawan. Silakan tunjukkan kode transaksi ini di loket perpustakaan untuk mengambil buku fisik.';
      break;
    ...
    case 'Dipinjam':
      ...
      description =
        'Buku telah tercatat aktif dipinjam. Mohon rawat buku dengan baik dan kembalikan sebelum batas waktu yang ditentukan.';
      break;
    ...
    case 'Dikembalikan':
      ...
      description =
        'Terima kasih! Buku yang Anda pinjam telah berhasil dikembalikan dan diverifikasi oleh pustakawan. Transaksi peminjaman telah selesai.';
      break;
    ...
    case 'Dibatalkan':
      ...
      description =
        'Mohon maaf, pengajuan peminjaman buku Anda telah dibatalkan atau ditolak oleh petugas perpustakaan.';
      break;
    ...
    case 'Terlambat':
      ...
      description =
        'Buku pinjaman Anda tercatat telah melewati tanggal jatuh tempo pengembalian. Mohon segera mengembalikan buku ke perpustakaan.';
      break;
    ...
    case 'Tidak Mengembalikan':
      ...
      description =
        'Peminjaman ini tercatat tidak mengembalikan buku atau buku dilaporkan hilang. Harap segera hubungi pustakawan untuk prosedur penggantian atau penyelesaian denda.';
      break;
  }
