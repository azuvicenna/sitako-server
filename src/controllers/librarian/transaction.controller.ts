...
export const createTransaction = async (req: Request, res: Response) => {
  try {
    ...
    const validationResult = await validateTransactionCreation(body.anggotaId, body.bukuId);
...
export const deleteTransaction = async (req: Request, res: Response) => {
  try {
    ...
    const result = await transactionService.deleteExistingTransaction(transactionId);
