...
export const calculationTypeEnum = pgEnum('tipe_kalkulasi_enum', ['Akumulasi', 'Flat']);
...
export const paymentMethodEnum = pgEnum('metode_pembayaran_enum', ['Tunai', 'Non-Tunai']);
...
export const fines = pgTable('fines', {
  ...
  metodePerhitungan: calculationTypeEnum('metode_perhitungan').default('Akumulasi').notNull(),
  createdAt: timestamp('created_at').defaultNow().notNull(),
});
...
export const transactions = pgTable('transactions', {
  ...
  status: transactionStatusEnum('status').default('Menunggu Persetujuan').notNull(),
  createdAt: timestamp('created_at').defaultNow().notNull(),
});
...
export const finePayments = pgTable('payments', {
  ...
  metodePembayaran: paymentMethodEnum('metode_pembayaran').default('Tunai').notNull(),
