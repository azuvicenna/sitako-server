...
import { getPaginationParams, sendSuccess, sendError, sendFail } from '@/utils/core/handler';
...
describe('Response and Pagination Utils', () => {
  ...
  describe('sendError', () => {
    it('should log the error and send a 500 response', () => {
      ...
      expect(spyLogger).toHaveBeenCalledWith('Error pada getUserData: Database timeout', {
        error: testError,
      });
